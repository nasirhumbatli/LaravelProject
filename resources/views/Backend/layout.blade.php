    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-lg"><b>NH</b>CMS</span>
            </a>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="{{route('manage.logout')}}" class="btn btn-default btn-flat">Çıxış</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active"><a href="{{route('manage.index')}}"><i class="fa fa-link"></i>
                    ...
                    <li><a href="{{route('slider.index')}}"><i class="fa fa-sliders"></i>
                            <span>Slider</span></a>
                    <li class="treeview active">
                        <a href="#"><i class="fa fa-link"></i> <span>İdarə Paneli</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="{{route('user.index')}}"><i class="fa fa-user"></i> <span>İdarəçi</span></a>
                            </li>
                            <li><a href="{{route('settings.index')}}"><i class="fa fa-cog"></i>
